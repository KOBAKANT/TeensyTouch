...
int samplesize = 2; // how much samples to take avarage, change if needed
int thresh = 10; // threshold to trigger MIDI notes, change if needed
...
void loop() {
  ...
  val2 = fastTouchRead(6);
  val3 = fastTouchRead(8);
  val4 = fastTouchRead(10);
  val5 = fastTouchRead(15);
  val6 = fastTouchRead(17);
  val7 = fastTouchRead(19);
  val8 = fastTouchRead(21);
